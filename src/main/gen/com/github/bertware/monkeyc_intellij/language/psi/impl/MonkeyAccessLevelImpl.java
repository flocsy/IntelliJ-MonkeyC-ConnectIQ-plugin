...
public class MonkeyAccessLevelImpl extends MonkeyPsiCompositeElementImpl implements MonkeyAccessLevel {

  public MonkeyAccessLevelImpl(@NotNull ASTNode node) {
    super(node);
  }
