package com.github.bertware.monkeyc_intellij.project;

import com.github.bertware.monkeyc_intellij.MonkeyCIcons;
import com.github.bertware.monkeyc_intellij.ide.actions.appsettings.ui.AppSettingsToolWindowFactory;
...
public class MonkeyProjectListener extends AbstractProjectComponent {
  ...
  private static ToolWindow createAppSettingsToolWindow(Project project, ToolWindowManager toolWindowManager) {
    ...
    toolWindow.setIcon(MonkeyCIcons.APP_SETTINGS13);
